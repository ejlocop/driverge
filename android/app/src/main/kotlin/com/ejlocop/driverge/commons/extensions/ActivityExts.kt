...
fun Activity.startCallScreeningPermissionScreen(requestId: Int) {
    Log.d("ActivityExts", "startCallScreeningPermissionScreen")
...
//    val intent: Intent = Intent(Telephony.Sms.Intents.ACTION_CHANGE_DEFAULT)
//        .putExtra(Telephony.Sms.Intents.EXTRA_PACKAGE_NAME,
//            applicationContext.packageName
//        )

    startActivityForResult(intent, requestId)
//    startActivityForResult(intentSms, requestId)
}