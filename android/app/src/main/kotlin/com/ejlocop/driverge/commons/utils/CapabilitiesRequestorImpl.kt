...
import com.ejlocop.driverge.commons.extensions.hasDialerCapability
import com.ejlocop.driverge.commons.extensions.startCallScreeningPermissionScreen
import com.ejlocop.driverge.commons.extensions.startSelectDialerScreen
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_ID_CALL_SCREENING || requestCode == REQUEST_ID_SET_DEFAULT_DIALER) {
            if (resultCode == android.app.Activity.RESULT_OK) {
                activityReference?.get()?.uiEvent?.postValue(PhoneCapabilityEnabled)
            } else {
